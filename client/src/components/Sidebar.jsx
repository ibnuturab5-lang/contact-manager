...
navigate('/login')
  ...
  return (
    <div className="fixed w-48 border-r min-h-screen bg-slate-100">
      ...
      <ul className="space-y-6 px-3 sm:px-6 mt-10">
        {SIDEBAR_DATA.map((item) => (
          <li
            key={item.id}
            className={` flex gap-3 items-center font  px-4 py-2 rounded-md ${
