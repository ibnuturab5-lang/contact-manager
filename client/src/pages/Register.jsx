        ...
        <div className='p-4 bg-white rounded-md w-[80%] md:w-[40%] shadow-2xl'>
            ...
            <form onSubmit={handleSubmit}>
                <div className='mb-4'>
                    ...
                    <input type="text" placeholder='your name' className='px-4 py-2 border w-full bg-slate-200 rounded-md outline-none' value={name} onChange={(e)=>setName(e.target.value)}/>
                </div>
                <div className='mb-4'>
